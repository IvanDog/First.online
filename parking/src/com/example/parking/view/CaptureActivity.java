...
import com.example.parking.R.raw;
...
import com.example.parking.viewfinder.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			resultIntent.setClass(CaptureActivity.this,MobilePaymentActivity.class);  
